...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        dox: {
            options: {
                title: 'tdaf-ccbroker-mobile-validator documentation'
            },
            files: {
                src: ['<%= jshint.lib.src %>'],
        ...
        exec: {
            ...
            xunitReport: {
                cmd:
                    'bash -c "mv ./xunit.xml <%= clean.reportTest[0] %>"'
            }
        },
    ...
    grunt.registerTask('test-report', 'Generate tests reports',
        ['clean:reportTest', 'mkdir:reportTest', 'simplemocha:build', 'exec:xunitReport']);
